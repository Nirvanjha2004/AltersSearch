...
- [x] 2. Implement backend data stores and utilities
...
- [x] 3. Implement backend auth handlers
  - [x] 3.1 Create `repo-api/src/auth/handlers.js` with `register` handler
  ...
  - [x] 3.3 Add `login` handler to `handlers.js`
  ...
  - [x] 3.5 Add `refresh` handler to `handlers.js`
  ...
  - [x] 3.7 Add `logout` handler to `handlers.js`
...
- [x] 4. Implement backend authenticate middleware
  - [x] 4.1 Create `repo-api/src/auth/middleware.js` with `authenticate` function
...
- [x] 8. Implement AuthContext and AuthProvider
  ...
  - [x] 8.3 Wrap the root layout with `AuthProvider` in `frontend/src/app/layout.tsx`
